...
<footer class="footer">
  <img src="<?= get_stylesheet_directory_uri(); ?>/img/handel-white.svg" alt="Logotipo Handel">
  <div class="container footer-info">
    ...
    ?>
    <small class="footer-copy">Todos os direitos reservados - Handel &copy; <?= date('y'); ?> - <?= $complete_address; ?></small>
</footer>
